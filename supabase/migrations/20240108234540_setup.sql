...
AS $$
DECLARE
  project_url TEXT := 'https://kwrfkfrumdlkszxvrftz.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imt3cmZrZnJ1bWRsa3N6eHZyZnR6Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1MzI0MDI2MCwiZXhwIjoyMDY4ODE2MjYwfQ.JyWShiq255G9127fUMy_-n6GzhMyemqbkMK8s_ROSdY';
